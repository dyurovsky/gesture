...
# Coding errors
x1 <- c("mom; ahir", "ardvark", "dog; at", "batteries", "nose; bbug", "beans", 
        "cow; boo", "boo_boo","brown_page", "butterly", "caker", "CD", "cerea", 
        "chick", "chik", "chil", "chld", "chiristmas_tree; engine; train", 
        "cirle", "eg", "fae", "garbgage", "girlg", "mom; hild", 
        "chocolate; ice_crema", "candy; jackbot", "jacker", "motorcycyle", 
        "mushrooom", "mustach", "noodel", "oowd", "orange)juice",
        "peah", "people", "mom; platn", "refriegerator", "scissor", "arm; seleeve", "wc", 
        "yellow_page")

# Fixed referents
y1 <- c("mom; hair", "aardvark", "dog; cat","battery", "nose; bug", "bean", 
        "cow; book", "cut", "page", "butterfly", "cake", "cd", "cereal", 
        "chicken", "chicken", "child", "child", "christmas_tree; engine; train", 
        "circle", "egg", "face", "garbage", "girl", "mom; child", 
        "chocolate; ice_crema", "candy; jackbot", "jacket", "motorcycle", "mushroom",
        "mustache", "noodle", "wood", "orange_juice", "peach", "person", "mom; plant", 
        "refrigerator", "scissors", "arm, sleeve","wax", "page")
