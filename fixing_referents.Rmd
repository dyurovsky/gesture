...
x1 <- c("mom; ahir", "ardvark", "dog; at", "batteries", "nose; bbug", 
        ...
        "girlg", "mom; hild", "ice_crema", "jackbot", 
        "jacker", "motorcycyle", "mushrooom", "mustach", "noodel", "oowd", 
        "orange)juice", "peah", "people", "mom; platn", "refriegerator",
        "scissor", "arm; seleeve", "wc", "chicken_nugget, french_fry", "boz", "cantelope", "eggplante", "nob", "pliers", "rabibit", "rubber_ruck", "scrw", "seleeve", "qater", "platn", "piant", "macine", "lawn_mower", "hant", "hild", "dipaer", "caryon", "bbug", "adrvark")
...
y1 <- c("mom; hair", "aardvark", "dog; cat","battery", "nose; bug", 
        ...
        "girl", "mom; child",  "ice_cream", "jackpot", 
        "jacket", "motorcycle", "mushroom", "mustache", "noodle", "wood",
        "orange_juice", "peach", "person", "mom; plant", "refrigerator", 
        "scissors", "arm, sleeve","wax", "chicken_nugget; french_fry", "box", "canteloupe", "eggplant", "knob", "plier", "rabbit", "rubber_duck", "screw", "sleeve", "", "plant", "paint", "machine", "lawnmower", "hand", "child", "diaper", "crayon", "bug", "aardvark")
