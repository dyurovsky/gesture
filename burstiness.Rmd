...
gleit<-fixed_runs %>%
<<<<<<< HEAD
  filter(subj==29, age==14, time> 100, time<1000) #arbitrary choice

ggplot(gleit, aes(x = as.factor(time), y = referent)) + 
  geom_tile(color = "black") + 
  theme(legend.position = "bottom")
=======
  filter(subj==29, age==22, time> 100, time<1000)#arbitrary choice
...
>>>>>>> aaa74450160198d3cca29ebba0d570b35cba027c
```
