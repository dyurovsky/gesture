...
datatable(child_referents, rownames=FALSE, width=600, caption="Child Referents")
count (child_referents)
...
datatable(parent_referents, rownames=FALSE, width=600, caption="Parent Referents")
count(parent_referents) 
...
datatable(spoken_referents, rownames = FALSE, width = 600, caption="Spoken Referents")
```
